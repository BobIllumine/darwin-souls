...
parser.add_argument('--ucb-infer', type=float, default=0.6, help='coeff for UCB infer')
parser.add_argument('--ucb-train', type=float, default=0.4, help='coeff for UCB train')
