...
Transition_dtype = np.dtype([('timestep', np.int32), ('state', np.uint8, (80, 45)), ('action', np.int32), ('reward', np.float32), ('nonterminal', np.bool_)])
blank_trans = (0, np.zeros((80, 45), dtype=np.uint8), 0, 0.0, False)
...
class SegmentTree():
  ...
  # Updates nodes values from current treez
